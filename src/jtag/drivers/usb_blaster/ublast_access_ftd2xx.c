...
static int ublast_ftd2xx_speed(struct ublast_lowlevel *low, int speed)
{
	LOG_DEBUG("TODO: ublast_speed() isn't implemented for libftd2xx!");
	return ERROR_OK;
}
